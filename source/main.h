...
static const char* AppClass = "ownned";
static const char* AppName = "ownned";
...
static int loginX = 300;
static int loginY = 400;
static int menuX = 600;
static int menuY = 450;
